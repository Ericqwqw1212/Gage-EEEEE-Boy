...
namespace MonsterLog.Data
{
    public class MockMonsterDB : IMonsterDAL
    {
        private static List<Monster> monsters = new List<Monster>() {
            ...
            new Monster{ Image="seaSerpent.jpg", Name="Sea Serpent", Diet="|Living creatures|", Habitat="|Habitat:Sea|", LifeSpan="Lifespan:250-300 years|", Size="|Gargantuan|", NaturalWeakness="|No known weaknesses, Good luck|",
